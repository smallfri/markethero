...
class TransactionalEmailSenderBehavior extends CBehavior
{
    
    // reference flag for group limit
    public $transactional_email_limit = 0;
    
    // reference flag for group offset
    public $transactional_email_offset = 0;
    
    // whether this should be verbose and output to console
    public $verbose = 0;
    
    public function sendTransactionalEmails()
    {
