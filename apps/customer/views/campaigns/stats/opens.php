...
<div class="col-lg-4">
    <div class="panel panel-default">
        ...
        <div class="panel-body" style="height:350px;">
            <div class="circliful-graph" data-dimension="250" data-text="<?php echo $campaign->stats->getUniqueOpensRate(true);?>%" data-info="<?php echo Yii::t('campaign_reports', 'Open rate');?>" data-width="30" data-fontsize="38" data-percent="<?php echo ceil($campaign->stats->getUniqueOpensRate());?>" data-fgcolor="#c6c7c8" data-bgcolor="#eee" data-border="inline" data-type="half"></div>
            <ul class="list-group">
