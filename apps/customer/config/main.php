    ...
    'components' => array(
        ...
        'urlManager' => array(
            'rules' => array(
                ...
                array('full_contact/create',
                    'pattern' => 'full_contact/create/<list_uid:([a-zA-Z0-9]+)>/subscriber/<sub_uid:([a-zA-Z0-9]+)>'),
        ...
        'getFullContact' => array(
            'class' => 'customers/extensions/Full_contactController'
        ),
    ),
