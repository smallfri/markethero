 ...
 * @property integer compliance_level_id
...
class GroupEmailCompliance extends ActiveRecord
{
	...
	public $compliance_level_id;

	public $last_processed_id;

	public $compliance_approval_user_id;
	...
	{
		$rules = array(
			array('group_email_id, compliance_level_id, date_added, last_updated', 'required'),
            array('date_added, last_updated', 'date', 'format' => 'yyyy-mm-dd hh:mm:ss'),

			// The following rule is used by search().
			array('group_email_id, compliance_level_id, date_added, last_updated, compliance_status, offset, compliance_approval_user_id, last_processed_id', 'safe', 'on'=>'search'),
		);
    ...
    public function relations()
    {
        ...
        $relations = array(
            'compliance' => array(self::BELONGS_TO, 'Group', 'group_email_id'),
				'compliance_levels' => array(self::HAS_MANY, 'GroupComplianceLevels', 'compliance_level_id'),
	...
	public function attributeLabels()
	{
		$labels = array(
			...
			'compliance_level_id'           => Yii::t('group_email_compliance', 'Compliance Level'),
...
//    }
	...
	public function search()
	{
		...
		$criteria->compare('t.compliance_level_id', $this->compliance_level_id, true);
