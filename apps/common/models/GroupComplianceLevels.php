...
class GroupComplianceLevels extends ActiveRecord
{
    ...
    public function rules()
    {
        ...
        $rules = array(
            ...
            array(
                'group_email_id, compliance_level_id, date_added, last_updated, compliance_status, offset, compliance_approval_user_id, last_processed_id',
                'safe',
                'on' => 'search'
            ),
        );
    ...
    public function relations()
    {
        ...
        $relations = array(
            'compliance_levels' => array(self::BELONGS_TO, 'GroupEmailCompliance', 'compliance_level_id'),
        );
