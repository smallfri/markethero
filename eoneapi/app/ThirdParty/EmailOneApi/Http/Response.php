<?php
/**
 * This file contains the EmailOneApi_Http_Response class used in the EmailOneApi PHP-SDK.
 * 
 *
 *
 *
...
/**
 * EmailOneApi_Http_Response is the class used to get the responses back from the API endpoints.
 * 
 *
 * @package EmailOneApi
 * @subpackage Http
 * @since 1.0
 */
class EmailOneApi_Http_Response extends EmailOneApi_Base
{
    /**
    ...
    /**
     * @var EmailOneApi_Params $headers the headers that came back in the response.
     */
    public $headers;
    ...
    /**
     * @var EmailOneApi_Params $curlInfo the curl info returned in the response.
     */
    public $curlInfo;
    
    /**
     * @var EmailOneApi_Params $body the body of the response.
     */
    public $body;
     ...
     * Contructor.
     * 
     * @param EmailOneApi_Http_Request $request
     */
    public function __construct(EmailOneApi_Http_Request $request)
    {
    ...
    public function populate(array $params = array())
    {
        if ($this->storeCurlInfo) {
            $this->curlInfo = new EmailOneApi_Params($params);
        }
