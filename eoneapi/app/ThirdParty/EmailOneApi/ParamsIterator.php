...
/**
 * EmailOneApi_ParamsIterator implements an interator for {@link EmailOneApi_Params}.
 *
 * It allows EmailOneApi_Params to return a new iterator for traversing the items in the map.
 * 
 ...
 */
class EmailOneApi_ParamsIterator implements Iterator
{
	/**
