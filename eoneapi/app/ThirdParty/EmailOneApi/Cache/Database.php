<?php
/**
 * This file contains the Database cache class used in the EmailOneApi PHP-SDK.
 * 
 *
 *
 *
...
/**
 * EmailOneApi_Cache_Database makes use of the PHP's {@link PDO} extension in order to cache data into a database.
 * 
 ...
 * @since 1.0
 */
class EmailOneApi_Cache_Database extends EmailOneApi_Cache_Abstract
{
    /**
     ...
     * @return EmailOneApi_Cache_Database
     */
