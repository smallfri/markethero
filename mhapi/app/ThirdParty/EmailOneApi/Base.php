<?php
/**
 * This file contains the base class for the EmailOneApi PHP-SDK.
 *
 *
 *
 *
...
/**
 * EmailOneApi_Base is the base class for all the other classes used in the sdk.
 * 
 *
 * @package EmailOneApi
 * @since 1.0
 */
class EmailOneApi_Base
{
    /**
    ...
    /**
     * @var EmailOneApi_Config the configuration object injected into the application at runtime
     */
    private static $_config;
    
    /**
     * @var EmailOneApi_Params the package registry that will hold various components
     */
    private static $_registry = array();
    
    /**
     * @var EmailOneApi_Params the registered event handlers
     */
     ...
     * 
     * @param EmailOneApi_Config $config
     */
    public static function setConfig(EmailOneApi_Config $config)
    {
        self::$_config = $config;
    }
    ...
    {
        if (!(self::$_registry instanceof EmailOneApi_Params)) {
            self::$_registry = new EmailOneApi_Params(self::$_registry);
        }
     ...
     * $components = array(
     *     'cache'=>array(
     *         'class'             => 'EmailOneApi_Cache_Sqlite',
    ...
    public function setComponent($componentName, array $config)
    {
        ...
        if ($component instanceof EmailOneApi_Base) {
