<?php
/**
 * This file contains the File cache class used in the EmailOneApi PHP-SDK.
 * 
 *
 *
 *
...
/**
 * EmailOneApi_Cache_File makes use of the file system in order to cache data.
 * 
 *
 * @package EmailOneApi
 * @subpackage Cache
 * @since 1.0
 */
class EmailOneApi_Cache_File extends EmailOneApi_Cache_Abstract
{
    /**
