...
if ($isAjaxRequest && !empty($_POST)) {
    ...
    $listUid    = 'ah2849chx4451';// you'll take this from your customers area, in list overview from the address bar.
    ...
    if ($response->itemAt('status') == 'success') {
        exit(EmailOneApi_Json::encode(array(
            'status'    => 'success',
...
<div class="col-lg-4" id="content">
    <!--
    The form below is generated by EmailOne EMA.
