...
//        echo "\n\nSanity Check: <a href=\"admin/load_models\" target=\"_blank\">Test Models</a>";
        ...
        echo "Emergency Rollback command: php-cgi -f d3pl0y.php p=d0i7 a=yes.rollback\n";
...
//        echo "rollback!";
    ...
    {
        echo "Are you sure you want to roll back? Use: php-cgi -f d3pl0y.php p=d0i7 a=yes.rollback\n\n";
...
//        echo "deploy!";
    ...
    {
        echo "Are you sure you want to deploy? Use: php-cgi -f d3pl0y.php p=d0i7 a=yes.deploy\n\n";
